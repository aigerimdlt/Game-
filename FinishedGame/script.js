...
document.querySelector('.check').addEventListener('click', function () {
  ...
  //задание! сделать проверку на пустой инпут  если  он пустой вывесьт сообщение "Введите число "
  ...
  if (!guessingNumber) {
    ...
    document.querySelector('.question').style.width = '50rem';2
...
// displayGuessMessage('fiewfiwefiwi')